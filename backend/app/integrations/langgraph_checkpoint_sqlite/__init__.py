"""Vendored from langchain-ai/langgraph checkpoint-sqlite (MIT).

Local copy introduced to keep checkpoint persistence capability available
inside this project without depending on an additional separately installed
...
from app.integrations.langgraph_checkpoint_sqlite.utils import search_where
